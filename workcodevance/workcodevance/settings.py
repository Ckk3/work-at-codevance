"""
Django settings for workcodevance project.
...
ROOT_URLCONF = 'workcodevance.urls'
...
WSGI_APPLICATION = 'workcodevance.wsgi.application'
...
DEBUG_TOOLBAR_CONFIG = {
    'SHOW_TOOLBAR_CALLBACK': 'workcodevance.settings.custom_show_toolbar',
}
